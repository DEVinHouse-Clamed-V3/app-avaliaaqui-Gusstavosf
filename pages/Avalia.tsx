...
import { Text, Alert, ScrollView, FlatList, SafeAreaView, View, TouchableOpacity, StyleSheet, TextInput, Button, TurboModuleRegistry } from "react-native"
import axios from 'axios'
import BouncyCheckbox from 'react-native-bouncy-checkbox'

export default function Avalia(navigation) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.containerBox}>
                ...
                <BouncyCheckbox style={{ marginVertical: 15 }}
                    size={20}
                    fillColor="#000000"
                    unFillColor="#FFFFFF"
                ...
                <View style={styles.containerReact}>
                    <TouchableOpacity
                        style={[styles.buttonReact, sentimento === 'Feliz' && styles.selectedButton]}
                        onPress={() => handlePress('Feliz')}
                    >
                        <Text style={[styles.buttonTextReact, sentimento === 'Feliz' && styles.selectedText]}>
                            😊 Feliz
                        </Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.buttonReact, sentimento === 'Bom' && styles.selectedButton]}
                        onPress={() => handlePress('Bom')}
                    >
                        <Text style={[styles.buttonTextReact, sentimento === 'Bom' && styles.selectedText]}>
                            🙂 Bom
                        </Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.buttonReact, sentimento === 'Médio' && styles.selectedButton]}
                        onPress={() => handlePress('Médio')}
                    >
                        <Text style={[styles.buttonTextReact, sentimento === 'Médio' && styles.selectedText]}>
                            😐 Médio
                        </Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.buttonReact, sentimento === 'Ruim' && styles.selectedButton]}
                        onPress={() => handlePress('Ruim')}
                    >
                        <Text style={[styles.buttonTextReact, sentimento === 'Ruim' && styles.selectedText]}>
                            😞 Ruim
                        </Text>
                    </TouchableOpacity>
                </View>
...
const styles = StyleSheet.create({
    ...
    enterButton: {
        backgroundColor: '#0054ba', // Cor do botão
        paddingVertical: 15,
        borderRadius: 10,
        alignItems: 'center',
        marginBottom: 20,
